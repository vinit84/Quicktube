    ...
    <>
      ...
      <NavbarWrapper/>  {/* Conditionally render Navbar */}
        <Routes>
          ...
          <Route path="/youtuber?authSuccess=true" element={<YoutuberDashboard/>} />
          <Route path="/youtuber/editors" element={<EditorsList/>} />
          <Route path="/editor/dashboard/:channelId" element={<EditorDashboard/>} />
          <Route path="/pricing" element={<Pricing/>} />
          <Route path="/editor/dashboard/:channelId/video/:videoId" element={<VideoDetails/>} />
          <Route path="/youtuber/dashboard/:channelId/video/:videoId" element={<VideoDetails/>} />
          <Route path="/youtuber/dashboard/:channelId/video/:videoId?authSuccess=true" element={<VideoDetails/>} />
